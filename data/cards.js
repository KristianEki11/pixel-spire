...
const CARDS = [
  ...
  { id:"war_dance",   name:"War Dance",     manaCost:2, type:"Buff",    rarity:"Epic", art:"assets/cards/war_dance.png", effect:{strength:2,draw:2}, description:"Gain {s} Strength. Draw 2 cards." },
  { id:"plague",      name:"Plague",        manaCost:2, type:"Debuff",  rarity:"Epic", art:"assets/cards/plague.png", effect:{poison:7}, description:"Apply {p} Poison." },
  { id:"time_warp",   name:"Time Warp",     manaCost:1, type:"Skill",   rarity:"Epic", art:"assets/cards/time_warp.png", effect:{energy:2,draw:1}, description:"Gain 2 mana. Draw 1 card." },
  { id:"sanctuary",   name:"Sanctuary",     manaCost:2, type:"Skill",   rarity:"Epic", art:"assets/cards/sanctuary.png", effect:{heal:12}, description:"Heal {h} HP." },
  { id:"mind_spike",  name:"Mind Spike",    manaCost:2, type:"Debuff",  rarity:"Epic", art:"assets/cards/mind_spike.png", effect:{weak:2,vulnerable:2,damage:6,hits:1}, description:"Deal {d} damage. Apply 2 Weak, 2 Vulnerable." },
  { id:"void_shield", name:"Void Shield",   manaCost:2, type:"Defense", rarity:"Epic", art:"assets/cards/void_shield.png", effect:{armor:15}, description:"Gain {a} Block. Exhaust." },

  /* ---------- LEGENDARY ---------- */
  { id:"meteor",      name:"Meteor",        manaCost:4, type:"Attack",  rarity:"Legendary", art:"assets/cards/meteor.png", effect:{damage:18,hits:1,aoe:true}, description:"Deal {d} damage to ALL enemies." },
  { id:"dragonfang",  name:"Dragonfang",    manaCost:3, type:"Attack",  rarity:"Legendary", art:"assets/cards/dragonfang.png", effect:{damage:10,hits:3}, description:"Deal {d} damage 3 times." },
  { id:"phoenix",     name:"Phoenix Heart", manaCost:3, type:"Skill",   rarity:"Legendary", art:"assets/cards/phoenix.png", effect:{heal:20,purge:true}, description:"Heal {h} HP. Remove your Poison." },
  { id:"titan_skin",  name:"Titan Skin",    manaCost:3, type:"Defense", rarity:"Legendary", art:"assets/cards/titan_skin.png", effect:{armor:18,strength:1}, description:"Gain {a} Block and {s} Strength." },
  { id:"omnislash",   name:"Omnislash",     manaCost:5, type:"Attack",  rarity:"Legendary", art:"assets/cards/omnislash.png", effect:{damage:7,hits:5}, description:"Deal {d} damage 5 times." },
  { id:"gods_hand",   name:"God's Hand",    manaCost:2, type:"Buff",    rarity:"Legendary", art:"assets/cards/gods_hand.png", effect:{strength:3,armor:8}, description:"Gain {s} Strength and {a} armor." },
  { id:"black_pact",  name:"Black Pact",    manaCost:0, type:"Skill",   rarity:"Legendary", art:"assets/cards/black_pact.png", effect:{energy:2,selfDamage:4}, description:"Gain 2 mana. Take 4 damage." },
  { id:"doom",        name:"Doom",          manaCost:3, type:"Debuff",  rarity:"Legendary", art:"assets/cards/doom.png", effect:{poison:6,aoe:true,weak:1}, description:"Apply {p} Poison and 1 Weak to ALL enemies." },
  { id:"demon_form",  name:"Demon Form",    manaCost:3, type:"Buff",    rarity:"Legendary", art:"assets/cards/demon_form.png", effect:{}, description:"At the start of your turn, gain 2 Strength." },
];
